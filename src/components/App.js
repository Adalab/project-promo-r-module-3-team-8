...
function App() {
  return (
    ...
    <header className="header__cards">
        <a href="index.html"><img className="header__cards--profile" src="./assets/images/logo-awesome-profile-cards0.svg"
    ...
    <footer className="footer">
        ...
        <img className="logo" src="./assets/images/logo-minionlab.png" alt="logo Adalab"/>
    </footer>
  );
}
